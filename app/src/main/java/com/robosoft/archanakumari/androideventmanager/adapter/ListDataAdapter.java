...
public class ListDataAdapter extends ArrayAdapter {
  ...
  //  DatabaseAdapter databaseAdapter = new DatabaseAdapter(context);
   // SQLiteDatabase sqLiteDatabase = databaseAdapter.helper.getReadableDatabase();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       /* row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int noOfRows = databaseAdapter.deleteRow(dataProvider.getmId());
                Log.i("Hi"," i am in OnClick for delete");
                list.remove(position);
                 notifyDataSetChanged();
               // Message.message(this, " " + noOfRows);
               Log.i("Hello","No of rows is deleted"+noOfRows);
            }
        });*/
        return row;
    }
